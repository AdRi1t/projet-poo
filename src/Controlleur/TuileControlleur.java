...
public class TuileControlleur {
	...
	/**
	 * Compte le nombre de {@link Model.Tuile#typeTuile} dans
	...
	public static boolean estRetournable(Tuile tuile) {
		...
		if (tuile.getTypeTuile() == TypeTuile.MONTAGNE && countTypeRestant(TypeTuile.PLAGE) == 0
				&& countTypeRestant(TypeTuile.FORET) == 0) {
			return true;
		}
		return false;
	}
